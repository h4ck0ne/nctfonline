                ...
                <ul class="nav navbar-nav">
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <?php if(isset($_SESSION['loggedin'])){($_SESSION['loggedin']==True)?(print '<li><a class="page-scroll" href="challenge.php">Challenge</a></li><li><a class="page-scroll" href="home.php">  '.$_SESSION['username'].'</a></li>'):(print '');}?>
